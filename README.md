...
- [Tutorial: First Global Workflow](docs/tutorials/first-global-workflow.md)
- [How-to: Install The CLI](docs/how-to/install-the-cli.md)
- [How-to: Add A Skill Quickly](docs/how-to/add-a-skill-quickly.md)
- [How-to: Enable Shell Completion](docs/how-to/enable-shell-completion.md)
...
- [How-to: Read Status And Sync Output](docs/how-to/read-status-and-sync-output.md)
- [Reference: CLI](docs/reference/cli.md)
- [Reference: Doctor](docs/reference/doctor.md)
- [Reference: Project Local Config](docs/reference/local-config.md)
