...
If you are new to the project, start with [First Project Sync](tutorials/first-project.md).

If you already know what you want to do, go to one of the Divio sections below.
...
- [Output And Status](reference/output-and-status.md)

## Explanation

Explanation is for the reasoning behind the system.
